...
INSERT INTO `caja` VALUES (1,10000.00,15900.00,'2017-12-11'),(2,111111.00,11111111.00,'2017-12-11');
...
INSERT INTO `cliente` VALUES (1,'Nataly','Paniagua'),(2,'Carlos','Abarca');
...
INSERT INTO `detallepedido` VALUES (1,2,3,3,NULL),(2,2,1,1,NULL),(4,2,1,1,NULL),(5,2,2,3,NULL);
...
INSERT INTO `estadopedido` VALUES (1,'1');
...
INSERT INTO `formapago` VALUES (1,'Contado'),(2,'Tarjeta Débito'),(3,'Tarjeta Credito');
...
INSERT INTO `pedido` VALUES (2,1,1.00,1,'2012-12-12',1,NULL);
...
INSERT INTO `sabor` VALUES (1,'Fresa',1,10),(2,'Chocolate',0,54),(3,'Menta Chocolate',1,2);
...
INSERT INTO `tipoproducto` VALUES (1,'Cono Chispas'),(2,'Paletas'),(3,'Batina Natural22');
...
INSERT INTO `tipousuario` VALUES (1,'Administrador'),(2,'Cajero');
...
INSERT INTO `usuario` VALUES (1,'Kevin','Sánchez Soto Sibaja','1','12',1),(2,'Bryan','Vásquez','2','1',1),(5,'1','1','1','1',1),(7,'Jorge','Campos','jcampos','asdfasdf',2),(8,'Maikol','Jordan','pollo','Frito',1);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_I_Caja`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PA_I_DetallePedido` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_I_DetallePedido`(
pPid int(11),
pproducto int(11),
psabor int(11))
BEGIN
	INSERT INTO `heladeria`.`detallepedido`
(
`pedidoID`,
`productoID`,
`saborID`)
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_I_Pedido`(
pclienteID int(11),
pcosto decimal (10,2),
pestado int(11),
pfecha date,
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_I_Producto`(pDescripcion varchar(45), pTipo int(11), pPrecio decimal(10,2), pEstado int(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_I_Sabor`(pDescripcion varchar(45), pEstado int(11), pCantidad  int(11) )
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PA_SeleccionarCaja` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_SeleccionarCaja`(pIdCaja int(11) )
BEGIN

Select * from caja
    where ((idcaja = pIdCaja) OR (pIdCaja = 0)) ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PA_SeleccionarDetallePedido` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_SeleccionarDetallePedido`(pIdPedido int(11),pIdDetallePedido int(11) )
BEGIN

Select dp.* , p.descripcion as producto , s.descripcion as sabor  from detallepedido as dp ,producto as p , sabor as s
    where ((dp.pedidoID = pIdPedido) OR (pIdPedido = 0)) and ((dp.iddetallePedido = pIdDetallePedido) OR (pIdDetallePedido = 0)) and dp.productoID=p.idProducto and dp.saborID=s.idSabor;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PA_SeleccionarEstadoPedido` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_SeleccionarEstadoPedido`(pIdEstadoPedido int(11) )
BEGIN

Select * from estadopedido
    where ((idestadoPedido = pIdEstadoPedido) OR (pIdEstadoPedido = 0)) ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PA_SeleccionarFormaPago` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_SeleccionarFormaPago`(pIdFormaPago int(11) )
BEGIN

Select * from formapago
    where ((idformaPago = pIdFormaPago) OR (pIdFormaPago = 0)) ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PA_SeleccionarPedido` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_SeleccionarPedido`(pIdPedido int(11) )
BEGIN

Select p.*,CONCAT(c.nombre, ' ', c.apellidos) as nombre , e.descripcion as estadox, f.descripcion as pago from pedido as p , cliente as c , estadopedido as e , formapago as f
    where ((idPedido = pIdPedido) OR (pIdPedido = 0)) and clienteID=c.idCliente and estado=e.idestadoPedido and pagoID=f.idformaPago;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_SeleccionarSabor`(pIdSabor int(11),pEstado int(11) )
BEGIN
...
-- Dump completed on 2017-12-11 16:25:26
