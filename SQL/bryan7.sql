...
INSERT INTO `caja` VALUES (1,10000.00,15900.00,'2017-12-11');
...
Select dp.* , p.descripcion as producto , s.descripcion as sabor ,e.descripcion as extra from detallepedido as dp ,producto as p , sabor as s , extra as e
    where ((pedidoID = pIdPedido) OR (pIdPedido = 0)) and ((iddetallePedido = pIdDetallePedido) OR (pIdDetallePedido = 0)) and productoID=p.idProducto and saborID=s.idSabor and extraID=e.idExtras;
...
-- Dump completed on 2017-12-11 15:12:17
